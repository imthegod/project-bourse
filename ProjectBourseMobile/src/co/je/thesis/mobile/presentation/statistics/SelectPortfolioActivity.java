...
public class SelectPortfolioActivity extends Activity implements OnItemClickListener {

	public static final String TAG = "SelectPortfolioActivity";
	...
	private void goToPortfolioStatisticsActivity(String portfolioName) {
		
		Bundle bundle = new Bundle();
		String key = "selectedPortfolioName";
		bundle.putString(key, portfolioName);
		Intent portfolioStatisticsActivityIntent = new Intent(this, PortfolioStatisticsActivity.class);
		portfolioStatisticsActivityIntent.putExtras(bundle);
		startActivity(portfolioStatisticsActivityIntent);
		this.finish();
	}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (position != 0) {
			...
			goToPortfolioStatisticsActivity(portfolioName);
		}
	}
}
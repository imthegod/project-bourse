...
public class AddSpecificStockActivity extends Activity implements OnClickListener {

	public static final String TAG = "AddSpecificStockActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		stockName = bundle.getString(key3);


		// Set portfolioName as tittle
		TextView title = (TextView) findViewById(R.id.portfolioName);
		title.setText(portfolioName);

		// Set stockSymbol as the stock symbol
		EditText inputSymbol = (EditText) findViewById(R.id.symbol);
		inputSymbol.setText(stockSymbol);

		// Set stockName as the stock name
		EditText inputName = (EditText) findViewById(R.id.name);
		inputName.setText(stockName);
